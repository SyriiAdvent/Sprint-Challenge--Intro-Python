...
print("Starts with D:")
a = [person.name for person in humans if person.name.lower().startswith('d')]
print(a)
...
c_g  = [letter for letter in 'cdefg']
print("Starts between C and G, inclusive:")
c = [person.name for person in humans if person.name[0].lower() in c_g] ####################
print(c)
